...
Source verification established edition-specific locations for all indexed lenses. The workflows are newly written adaptations and operational additions, not verbatim author procedures. Source notes document the absent printed page 68 and the boundary between source concepts and modern adaptations. Any installation or marketplace registration is described in the companion delivery note rather than inferred from these checks.
